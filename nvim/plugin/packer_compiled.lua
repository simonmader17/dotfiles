...
_G.packer_plugins = {
  ...
  ["cellular-automaton.nvim"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/cellular-automaton.nvim",
  ...
  ["code-stats-vim.git"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/code-stats-vim.git",
    url = "https://gitlab.com/code-stats/code-stats-vim"
  },
  delimitmate = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/delimitmate",
  ...
  ["nvim-highlight-colors"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/nvim-highlight-colors",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
